...
# inputs_file_path = 'ha_train_set/inputs.csv'
# data = pd.read_csv(inputs_file_path)

# # Load the labeled data containing heart disease results
# labeled_data_file = 'ha_train_set/labels.csv'
# labeled_data = pd.read_csv(labeled_data_file)

input_file_path = "ha_train_set/sample_data.csv"
data = pd.read_csv(input_file_path)

print(f"Data Columns are: {data.columns}")
...
for index, patient in data.iterrows():
    ...
    descriptions.append({'PatientID': patient_id, 'Description': description, 'HadHeartAttack': patient['HadHeartAttack']})
...
train_output_file_path = 'train_patient_descriptions.csv'
test_output_file_path = 'test_patient_descriptions.csv'
